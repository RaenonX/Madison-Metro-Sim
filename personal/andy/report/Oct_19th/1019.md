...
of the total revenue of that year. In 2016, it accounts for 81% of the total revenue as a result of the funding loss. 
...
Ideally, me and Jeremy currently working on the dataset we found on National Transit Database. Our 
...
So, instead of looking at the overlaps of the routes (which I think Megan and Ray are working on it), 
Jeremy and I will be looking at the other factors that caused the rise/fall in the revenue trend.
In addition, we'll also be interested in working with the Madison Metro Simulator, so I really hope 
we can all meet in the Thursday morning. 